...
export default function EditProduct({productId, handleClose,doRefetch}) {
  ...
  return (
    <div style={{width:'40%',}}>
      ...
      <Dialog open={productId} onClose={handleClose} aria-labelledby="form-dialog-title" fullWidth>
        ...
        <DialogActions>
          <Button onClick={editProduct} color="primary" disabled={disabled}>
            Aceptar
          </Button>
